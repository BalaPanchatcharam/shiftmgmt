package com.braziljs.loiane.web;
...
import com.braziljs.loiane.model.ContactWrapper;
import com.braziljs.loiane.model.Employee;
import com.braziljs.loiane.service.ContactService;
import com.braziljs.loiane.util.ExtJSReturn;
...
public class ContactController  {
	...
	public @ResponseBody Map<String,? extends Object> view(@RequestParam (value="won", required = false) String won, @RequestParam int start, @RequestParam int limit) throws Exception {
		...
		try{
			...
			return ExtJSReturn.mapOK(contacts, contacts.size());
